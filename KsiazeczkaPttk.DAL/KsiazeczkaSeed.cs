...
namespace KsiazeczkaPttk.DAL
{
    public static class KsiazeczkaSeed
    {
        public static async Task Seed(KsiazeczkaContext context)
        {
            ...
            {
                new Odcinek { Id = 1, Wersja = 1, Nazwa = "Z Rusinowej Polany do Gęsiej Szyji", Aktywny = true, Pasmo = pasmaGorskie[0].Id, PasmoGorskie = pasmaGorskie[0], Punkty = 4, PunktyPowrot = 1, Od = punktyTerenowePubliczne[0].Id, PunktTerenowyOd = punktyTerenowePubliczne[0], Do = punktyTerenowePubliczne[2].Id, PunktTerenowyDo = punktyTerenowePubliczne[2] },
                new Odcinek { Id = 2, Wersja = 1, Nazwa = "Z Równi Waksmudzkiej do Gęsiej Szyji", Aktywny = true, Punkty = 2, PunktyPowrot = 1, Od = punktyTerenowePubliczne[3].Id, PunktTerenowyOd = punktyTerenowePubliczne[3], Do = punktyTerenowePubliczne[2].Id, PunktTerenowyDo = punktyTerenowePubliczne[2], Pasmo = pasmaGorskie[0].Id, PasmoGorskie = pasmaGorskie[0] },
                new Odcinek { Id = 3, Wersja = 1, Nazwa = "Z Psiej Trawki do Równi Waksmudzkiej", Aktywny = true, Punkty = 5, PunktyPowrot = 3, Od = punktyTerenowePubliczne[4].Id, PunktTerenowyOd = punktyTerenowePubliczne[4], Do = punktyTerenowePubliczne[3].Id, PunktTerenowyDo = punktyTerenowePubliczne[3], Pasmo = pasmaGorskie[0].Id, PasmoGorskie = pasmaGorskie[0] },
                new Odcinek { Id = 4, Wersja = 1, Nazwa = "Ze Schroniska PTTK na Hali Gąsienicowej do Psiej Trawki", Aktywny = true, Punkty = 4, PunktyPowrot = 7, Od = punktyTerenowePubliczne[9].Id, PunktTerenowyOd = punktyTerenowePubliczne[9], Do = punktyTerenowePubliczne[4].Id, PunktTerenowyDo = punktyTerenowePubliczne[4], Pasmo = pasmaGorskie[0].Id, PasmoGorskie = pasmaGorskie[0] },
                new Odcinek { Id = 5, Wersja = 1, Nazwa = "Ze schroniska PTTK nad Morskim okien do Czarnego stawu nad Morskim Okiem", Aktywny = true, Punkty = 4, PunktyPowrot = 2, Od = punktyTerenowePubliczne[5].Id, PunktTerenowyOd = punktyTerenowePubliczne[5], Do = punktyTerenowePubliczne[6].Id, PunktTerenowyDo = punktyTerenowePubliczne[6], Pasmo = pasmaGorskie[0].Id, PasmoGorskie = pasmaGorskie[0] },
            };

            var odcinkiPrywatne = new List<Odcinek>
            {
                new Odcinek { Id = 101, Wersja = 1, Nazwa = "Ze Schroniska PTTK na Hali Gąsienicowej do Doliny Pańczyca", Aktywny = true, Punkty = 2, PunktyPowrot = 3, Od = punktyTerenowePubliczne[9].Id, PunktTerenowyOd = punktyTerenowePubliczne[9], Do = punktyTerenowePrywatne[0].Id, PunktTerenowyDo = punktyTerenowePrywatne[0], Pasmo = pasmaGorskie[0].Id, PasmoGorskie = pasmaGorskie[0], Wlasciciel = ksiazeczki[0].Wlasciciel, Ksiazeczka = ksiazeczki[0] },
            };
